...
class MonteCarloTester:
    ...
    # Test a sequence of actions in the game
    ...
    # Update the variance of the predictions
    ...
    # Simulate complete sequences from the incomplete ADS
    def simulate_ADS(self, seq):
        ...
        try:
            transitions = []
            if before_state_string in seq.TrA_trails.keys():
        ...
        # simulation step
        # find a random transition that has 7 empty tiles, for convention it is already added to seq.keylist
